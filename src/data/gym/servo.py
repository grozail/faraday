...
class ServoSimulation(object):
    def __init__(self, kt, jm, jl, cs, cd, fsf, fvf, dt=0.0000625):
    ...
    def step_with_current(self, current, tl=0):
        self._step(current, tl)
...
def create_rd50(dt=0.001):
    return ServoSimulation(0.04, 1.2e-4, 1.2e-4, 0.47, 5e-3, 0.042, 2e-5, dt)